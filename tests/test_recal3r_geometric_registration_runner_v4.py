...
from stateguard3r.recal3r_geometric_registration_runner_v4 import GeometricRegistrationRunnerError, _reset_requested
...
def test_runner_error_is_distinct_recovery_failure() -> None:
    assert issubclass(GeometricRegistrationRunnerError, RuntimeError)
